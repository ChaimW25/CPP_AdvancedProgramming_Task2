...
TEST_CASE("Good input") {
        CHECK(n.write(9, 7, 9,Direction::Horizontal, "s") == n.read(9,7,9,Direction::Horizontal,1) );

        CHECK(n.write(0, 7, 9,Direction::Horizontal, "s") == n.read(9,7,9,Direction::Horizontal,1) );

        CHECK(n.write(0, 0, 0,Direction::Horizontal, "s") == n.read(9,7,9,Direction::Horizontal,1) );
